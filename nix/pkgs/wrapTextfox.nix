{
  ...
  browser: lib.makeOverridable ({ 
    ...
    textfoxChrome = runCommand "textfox-chrome" {
  ...
  in (wrapFirefox browser (
    ...
    buildCommand = let
      libName = args.libName or browser.libName or browser.binaryName or (lib.getName browser);
    in 
      old.buildCommand
      + ''
