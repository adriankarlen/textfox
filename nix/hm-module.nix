  ...
  config = lib.mkIf cfg.enable {
    ...
    home.file."${configDir}${cfg.profile}/chrome/config.css" = {
      text = lib.strings.concatStrings [
        ...
        (lib.strings.concatStrings [ " --tf-accent: " cfg.config.font.accent ";" ])
        (lib.strings.concatStrings [ " --tf-bg: " cfg.config.background.color ";" ])
        (lib.strings.concatStrings [ " --tf-border: " cfg.config.border.color ";" ])
        ...
        (lib.strings.concatStrings [ " --tf-margin: " cfg.config.sidebery.margin ";" ])
        ...
        (lib.strings.concatStrings [ " --tf-display-sidebar-tools: " (if cfg.config.displaySidebarTools then "flex" else "none") ";" ])
